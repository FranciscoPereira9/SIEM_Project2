$(document).ready(function(){ 
  ...
  function filter_data() {
      ...
      $.ajax({
          ...
          method:"POST",
          data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, category:category, color:color, brand:brand, gender: gender}, // JSON data to send
          success:function(data){ //callback function
            // Update diplay of products
